...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializer05bf8 && ($this->initializer05bf8->__invoke($valueHolder685f0, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer05bf8) || 1) && $this->valueHolder685f0 = $valueHolder685f0;

        return $this->valueHolder685f0->find($className, $id, $lockMode, $lockVersion);
    }
