...
class __TwigTemplate_c2c0964e4a3185c6de562db3624545bcc8b051b67aba9e131abda71f54697ae9 extends \Twig\Template
{
    private $source;
    private $macros = [];
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
                ...
                if ((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["message"], "parameters", [], "any", false, false, false, 218)) > 0)) {
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["parameters"]) {
                        // line 223
                        echo "                                ";
                        echo $this->env->getFunction('profiler_dump')->getCallable()($this->env, $context["parameters"], 1);
                        echo "
                            ";
                    }
                    $_parent = $context['_parent'];
...
{% endmacro %}
", "WebProfilerBundle:Collector:translation.html.twig", "/Applications/MAMP/htdocs/P8_18052023/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/translation.html.twig");
    }
}
