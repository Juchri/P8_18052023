...
class __TwigTemplate_5da55470e8b04496e5b77578a0f290980eda5842b593e16957085bb8700c317b extends \Twig\Template
{
    private $source;
    private $macros = [];
                ...
                <div class=\"card\">
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["messagePart"]) {
                        if (twig_in_filter(twig_get_attribute($this->env, $this->source, $context["messagePart"], "contentType", [], "any", false, false, false, 166), [0 => "text/plain", 1 => "text/html"])) {
                            ...
                            <pre>";
                            // line 170
                            if (twig_get_attribute($this->env, $this->source, $context["messagePart"], "charset", [], "any", false, false, false, 170)) {
                                // line 171
