...
class __TwigTemplate_083347e9828b02a3db614c519f6c19c268bc9f8cd7b8f12914a8a392be0685dc extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        // line 424
        if (((isset($context["position"]) || array_key_exists("position", $context) ? $context["position"] : (function () { throw new RuntimeError('Variable "position" does not exist.', 424, $this->source); })()) == "top")) {
            // line 425
            echo "    .sf-minitoolbar {
...
";
        // line 445
        if ( !(isset($context["floatable"]) || array_key_exists("floatable", $context) ? $context["floatable"] : (function () { throw new RuntimeError('Variable "floatable" does not exist.', 445, $this->source); })())) {
            // line 446
...
";
    ...
    {
        return array (  520 => 450,  514 => 446,  512 => 445,  509 => 444,  488 => 425,  486 => 424,  286 => 227,  279 => 223,  272 => 219,  265 => 215,  259 => 212,  253 => 209,  45 => 3,  43 => 2,);
    }
